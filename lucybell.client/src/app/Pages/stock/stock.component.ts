...
<image id="image0_1031_11" width="100" height="100" xlink:href="data:image/png;base64,"/>
 ...
 ngOnInit(): void {
  ...
  this.ProductoService.GetProductoCompleto().subscribe((productos) => {
    ...
    console.log('Productos raw response:', productos);

    this.variantesConProducto = productos.flatMap(producto => {
      // Log each product object for debugging
      console.log('Processing product:', producto);
      ...
      return producto.variantesProducto.map(variante => {
        ...
        // Log each variante and its associated image URL
        console.log('Processing variante:', variante, 'with image URL:', imagen);
    ...
    // Log the processed data to verify it matches the expected format
    console.log('Variantes con producto:', this.variantesConProducto);
  });
}
